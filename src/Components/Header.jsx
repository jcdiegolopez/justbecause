const Header = ( {manageOpen} ) => {
    return (
        ...
        <div className="absolute top-[-0.06rem] left-[0rem] bg-morado w-full overflow-hidden flex flex-row items-center justify-between pt-[1.25rem] px-[2rem] pb-[1.27rem] box-border ">
          <img
